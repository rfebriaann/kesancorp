    ...
    <div class="grid grid-cols-3 h-screen p-10 gap-10">
        <div class="grid grid-rows-1">
            <div class="flex flex-col items-left justify-center">
                ...
                <h1 class="text-5xl font-bold p-2">Hello there...👋</h1>
                        ...
                        <div class="mt-4">
                            <div class="w-full">
                                <div class="relative h-12 w-full min-w-[200px]">
                                    ...
                                    class="form-control @error('email') is-invalid @enderror peer h-full w-full rounded-[7px] border border-blue-gray-200 bg-transparent px-3 py-2.5 !pr-9 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-[#010202] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                    placeholder=" "
                                    />
                        ...
                        <div class="mt-4">
                            <div class="w-full">
                                <div class="relative h-12 w-full min-w-[200px]">
                                    ...
                                    class="form-control @error('password') is-invalid @enderror peer h-full w-full rounded-[7px] border border-blue-gray-200 bg-transparent px-3 py-2.5 !pr-9 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-[#010202] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                    placeholder=" "
                                    />
                                    @error('password')
                                        <div class="invalid-feedback">
