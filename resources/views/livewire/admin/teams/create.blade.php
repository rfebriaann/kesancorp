<div>
    <div class= rounded-lg dark:border-gray-700">
        <div class="p-10 mx-10">
            <h1 class="font-bold text-4xl text-black">✊ Tambah Posisi </h1>
                                    ...
                                    <div class="space-y-6">
                                        <div class="grid grid-cols-1 gap-2 lg:grid-cols-2 lg:gap-10">
                                            <div class="space-y-1">
                                                ...
                                                >
                                                    Nama Team <span class="text-red-600">*</span>
                                                </label>
                                                <p class="text-sm text-gray-600">
                                                    Tambahkan nama team dengan lengkap dan benar
                                                </p>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-1 gap-2 lg:grid-cols-2 lg:gap-10">
                                            <div class="space-y-1">
                                                <label 
                                                    ...
                                                    class="font-medium  text-gray-800"
                                                >
                                                    Posisi yang bersangkutan <span class="text-red-600">*</span>
                                                </label>
                                                <p class="text-sm text-gray-600">
                                                    Pilih posisi yang bersangkutan, jikalau tidak ada silahkan tambahkan posisi terlebih dahulu
                                                </p>
                                            </div>
                                            <div class="pt-0 lg:pt-3">
                                                <select 
